...
-- 
-- Host: localhost
-- Generation Time: Jul 03, 2011 at 08:04 PM
...
CREATE TABLE `channel` (
  ...
  `publishing` tinyint(1) default NULL,
  PRIMARY KEY  (`id`),
...
INSERT INTO `channel` VALUES (10, 'CH5', 'DESC2', '0000-00-00 00:00:00', 1, 1, 0);
INSERT INTO `channel` VALUES (12, 'Shymaa Fans', 'dddd', '0000-00-00 00:00:00', 1, 10, 0);
INSERT INTO `channel` VALUES (15, 'looooooooooooo', 'dada', '0000-00-00 00:00:00', 1, 21, 0);
INSERT INTO `channel` VALUES (16, 'Era', 'loveeeeee', '2011-06-24 19:04:56', 1, 2, 1);
INSERT INTO `channel` VALUES (17, 'FATMA FANS', 'dasdasdsa', '0000-00-00 00:00:00', 1, 23, 1);
INSERT INTO `channel` VALUES (18, 'ooooooo', 'oooodasda', '0000-00-00 00:00:00', 1, 24, 0);
INSERT INTO `channel` VALUES (19, 'lllllllllllllllll', 'opppp', '0000-00-00 00:00:00', 1, 25, 0);
...
INSERT INTO `ci_sessions` VALUES ('526186c0c67ab777a97a9fd0171acea4', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/534.30 (K', 1309712229, 'a:4:{s:8:"username";s:3:"era";s:7:"user_id";s:1:"2";s:6:"logged";b:1;s:10:"channel_id";s:2:"16";}');
...
INSERT INTO `external_comment` VALUES (25, 'era', '', 28, 'fsdfdsfds', '2011-07-03 10:10:10', 2);
INSERT INTO `external_comment` VALUES (26, 'era', '', 29, 'dasdsada', '0000-00-00 00:00:00', 2);
INSERT INTO `external_comment` VALUES (27, 'era', '', 28, 'thanks', '0000-00-00 00:00:00', 2);
INSERT INTO `external_comment` VALUES (28, 'era', '', 28, 'dadsad', '0000-00-00 00:00:00', 2);
...
INSERT INTO `video` VALUES (28, 'dasddasda', 'fsafadasd', 16, '0000-00-00 00:00:00', 1, 1, 'uploads/22535.flv', 'thumbs/22535.png');
INSERT INTO `video` VALUES (29, 'aaaaaassssdddd', 'asddd', 16, '0000-00-00 00:00:00', 1, 1, 'uploads/25570.flv', 'thumbs/25570.png');
...
ALTER TABLE `live_stream`
  ADD CONSTRAINT `live_stream_ibfk_1` FOREIGN KEY (`access_control_id`) REFERENCES `access_control` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
